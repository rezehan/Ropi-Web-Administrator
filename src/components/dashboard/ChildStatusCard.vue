...
const { canvasRef } = useStatusGauge(toRef(props, 'percent'), toRef(props, 'sensorOk'))
...
// Trend di sini artinya arah skor risiko (bukan baterai) — naik = makin waspada,
// jadi warnanya kebalik dari kartu baterai lama: naik = merah, turun = hijau.
